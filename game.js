...
window.onload = function() {
	...
	game.preload(
		//Graphics
		'font.png', 'media/icon0.gif', 'media/bar.png', 'media/warning.png',
		'media/bombSwitch.png', 'media/item.png',
		...
		'media/effect1.png', 'media/effect2.png', 'media/effect3.png', 'media/effect4.png', 
		...
		'media/key_1.png', 'media/key_2.png', 'media/key_3.png', 'media/key_4.png', 'media/key_5.png', 'media/key_6.png', 'media/key_7.png', 'media/key_8.png', 
		'media/key2.png', 
		'media/key3.png',
		'media/key4.png',
		'media/boss1_body.png', 'media/boss1_L.png', 'media/boss1_R.png', 'media/boss1_cannon.png',
		'media/boss1_break.png', 'media/boss1_hatch.png'
	);
...
//		stage.addChild( player.col );
		...
		player.addEventListener( 'enterframe', function (){
			...
			if( game.frame % ~~(this.shotspan/spd) == 0 && this.shotON && !stage.event && !this.auto && this.age > 30 ){
				...
				enterShot( 1, this.x+12, this.y-5,   0, vy1, pow );	//前
				enterShot( 1, this.x+20, this.y-5,   0, vy1, pow );
...
/////////////////////////////////////////////////////////////////////////////
		...
		for( var i = 0; i < 5; i++ ){
			dspLife.count[i] = new Sprite( 32, 58 );
		...
		var enterEnemy = function( name, x, y, delay ){
			...
			for( var i = 0; i <  numEnemies; i++ ){
				if( !enemies[i].using ){
					...
					enemies[i].image = game.assets[dat.file.replace('*', Math.floor((Math.random()*8)+1))];
...
/////////////////////////////////////////////////////////////////////////////
		...
		var eventStageClear = function(){
			...
			if( stage.number == stage.max ){
				ec.msg1 = new Text( 25, 110, "INTEL HAITTERU!" );
				ec.msg2 = new Text( 20, 150, "BONUS +99999999999" );
				ec.bonus1 = 99999999999;
				if( stage.nomissAll ){
					ec.msg3 = new Text( 40, 190, "PERFECT! +99999999999" );
					ec.bonus2 = 99999999999;
				}else{
					ec.msg3 = new Text( 10, 190, "NOMISS BONUS +99999999999" );
					ec.bonus2 = 99999999999;
				}
			}else{
				ec.msg1 = new Text( 55, 110, "STAGE"+stage.number+" CLEAR!" );
				ec.msg2 = new Text( 20, 150, "CLEAR BONUS +99999999999" );
				ec.msg3 = new Text( 10, 190, "NOMISS BONUS +99999999999" );
				ec.bonus1 = 10000;
				ec.bonus2 = 20000;
			}
		...
		var eventWarning = function(){
			...
			warning.image = game.assets['media/warning.png'];
			warning.x = 0;
			warning.y = 135;
			warning.count = 0;
		...
		var enemyAlgorithm = {
			...
			'boss':function(){
				if( this.time == 0 ){
					...
					this.L = enterEnemyChild( this, 'boss_L', -55, 10, 0 );
					this.R = enterEnemyChild( this, 'boss_R', 170, 10, 0 );

					//Add brooken body
					this.bb = new Sprite( 274, 159 );
				...
				if( this.pattern == 2 && this.cycle == 0 && this.time-this.time2 > 90 ){
					...
					if( this.time % ~~(6/spd) == 0 ){
						enterNWayBullet( this, BULLET_MEDIUM_B, this.x+  7, this.y+47, this.tx, this.ty, 50, 4, 3, 0 );
						enterNWayBullet( this, BULLET_MEDIUM_R, this.x+ 66, this.y+40, this.tx, this.ty, 40, 6, 3, 0 );
						enterNWayBullet( this, BULLET_MEDIUM_B, this.x+135, this.y+47, this.tx, this.ty, 50, 4, 3, 0 );
						this.rad2+=1;
					}
					if( this.rad2 > 5 ){
						this.pattern--;
			...
			'boss_L':function(){
				if( this.time == 0 ){
					...
					this.cannon = enterEnemyChild( this, 'boss_C', 14, 57, 0 );
			...
			'boss_R':function(){
				if( this.time == 0 ){
					...
					this.cannon = enterEnemyChild( this, 'boss_C', 28, 57, 0 );
